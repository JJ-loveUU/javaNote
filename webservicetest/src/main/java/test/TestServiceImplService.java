 ...
 * 
 */
@WebServiceClient(name = "TestServiceImplService", targetNamespace = "http://webservicetest.example.com/", wsdlLocation = "http://localhost:8002/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TESTSERVICEIMPLSERVICE_QNAME = new QName("http://webservicetest.example.com/", "TestServiceImplService");
    ...
    public TestServiceImpl getTestServiceImplPort() {
        return super.getPort(new QName("http://webservicetest.example.com/", "TestServiceImplPort"), TestServiceImpl.class);
    }
    ...
    public TestServiceImpl getTestServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservicetest.example.com/", "TestServiceImplPort"), TestServiceImpl.class, features);
    }
